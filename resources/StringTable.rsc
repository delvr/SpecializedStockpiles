StringTable objects {
	Entry _strings [
		...
		{ String _name = "StorageYardFirewood";    String _text = "Firewood Stock Pile"; }
		{ String _name = "StorageYardFirewoodLwr"; String _text = "Firewood stock pile"; }
		{ String _name = "StorageYardFirewoodTip"; String _text = "Used to store firewood."; }
		...
		{ String _name = "StorageYardCoal";    String _text = "Coal Stock Pile"; }
		{ String _name = "StorageYardCoalLwr"; String _text = "coal stock pile"; }
		{ String _name = "StorageYardCoalTip"; String _text = "Used to store coal."; }
	]
}